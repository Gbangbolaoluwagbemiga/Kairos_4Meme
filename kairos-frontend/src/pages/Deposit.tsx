...
import { addressUrl, KAIROS_API_URL } from '@/lib/fourmeme';
...
export default function Deposit() {
  ...
  const handleFaucetRequest = async () => {
    ...
    try {
      toast.info('Requesting funds from Four.meme Sprint faucet...');
      const res = await fetch(`${KAIROS_API_URL}/api/fourmeme/faucet`, {
        method: 'POST',
        ...
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <div className="pb-3">
            ...
            <p className="text-sm text-muted-foreground mt-0.5">
              Fund your wallet to start querying agents (on-chain receipts included)
            </p>
          </div>
            ...
            <div className="space-y-6">
              {!chainOk && (
                <div className="glass-card p-4 border border-rose-500/20 bg-rose-500/5 text-sm text-rose-200">
                  Your wallet is not on BNB Testnet. Switch to chainId 97 to see correct balances and receipts.
                </div>
              )}
              {/* Current Balance */}
              ...
              <p className="text-4xl font-display font-semibold">
                  ...
                  <span className="text-lg text-muted-foreground ml-2">BNB</span>
                </p>
                <div className="flex items-center gap-1.5 mt-3">
                  <span className="status-dot" />
                  <span className="text-xs text-muted-foreground">BNB Chain Testnet</span>
                </div>
              </div>
              ...
              <div className="glass-card glass-shimmer p-6">
                ...
                <div className="bg-secondary rounded-lg p-4 border border-border/30">
                  <p className="text-xs text-muted-foreground mb-2">
                    Send testnet BNB to this address (chainId 97)
                  </p>
              ...
              <div className="glass-card glass-shimmer p-6">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Request a small amount of testnet BNB to try Kairos agents. Limited to one request per 24 hours.
                </p>
                <button
